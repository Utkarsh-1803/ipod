    ...
    import sound1 from './assets/music/Despacito.mp3'
    import sound2 from './assets/music/OnMyWay.mp3'
    import sound3 from './assets/music/Senorita.mp3'
                ...
                activeRegion.bind(containerElement, 'rotate', function(event){
                    ...
                    if(newAngle < 0){
                        ...
                        if(change === 15){
                            ...
                            change = 0;
                            // for rotation of wheel clockwise
                            ...
                            else if(self.state.activePage === 'MyMusic'){
                                if(self.state.activeItem === 'Despacito'){
                                    self.setState({
                                        activeItem : "OnMyWay"
                                    })
                                }else if(self.state.activeItem === 'OnMyWay'){
                                    self.setState({
                                        activeItem : "Senorita"
                                    })
                                }else if(self.state.activeItem === 'Senorita'){
                                    self.setState({
                                        activeItem : "Despacito"
                                    })
                                }
                            }
                    ...
                    // for rotation of wheel anticlockwise
                    else{
                        console.log(change);
                        change++;
                        if(change === 15){
    ...
    // Go to back page by clicking Menu
        changePageToHomeScreen = () => {
            ...
            } else if(this.state.activeItem === 'Despacito' || this.state.activeItem === 'OnMyWay' || this.state.activeItem === 'Senorita'){
                this.setState({
                    activeItem : 'MyMusic',
                    activePage : 'Music'
                })
        ...
        // for play and pause of song

        toggle = () =>{
            if(this.state.activeItem === 'Despacito'){
            ...
            if(this.state.activeItem === 'OnMyWay'){
                if(this.state.play === true){
            ...
            if(this.state.activeItem === 'Senorita'){
                if(this.state.play === true){
        ...
        componentDidMount(){
            let audio1 = document.getElementsByClassName("audio-element-1")[0];
            let audio2 = document.getElementsByClassName("audio-element-2")[0];
            let audio3 = document.getElementsByClassName("audio-element-3")[0];
            this.setState({
                audio1 : audio1,
                audio2 : audio2,
                audio3 : audio3,
            ...
            return(
                <div style = {styles.ipodContainer}>
                        ...
                        <audio className="audio-element-3">
                            <source src={sound3}></source>
                        </audio>
                        
                    <Screen activeItem={this.state.activeItem} activePage={this.state.activePage} audio1={this.state.audio1} audio2={this.state.audio2} audio3={this.state.audio3}/>
