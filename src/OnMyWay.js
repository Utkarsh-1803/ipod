    ...
    import onmyway from './assets/images/OnMyWay.jpg'

    class Senorita extends React.Component{
            ...
            return(
                <div style={styles.myMusicContainer}>
                    ...
                    <div style={styles.info}>
                        <img style={styles.image} src={onmyway}></img>
                        <div style={styles.subInfo}>
                            <h4 style={{marginBottom:'0.5rem'}}>OnMyWay</h4>
